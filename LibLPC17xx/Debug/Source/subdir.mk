...
Source/%.o: ../Source/%.c
	...
	arm-none-eabi-gcc -DDEBUG -D__NEWLIB__ -U__REDLIB__ -U__CODE_RED -I"O:\good version\DFRobotRTOS_T2_S1\LibLPC17xx\Include" -I"O:\good version\DFRobotRTOS_T2_S1\LibCMSIS\Include" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -mcpu=cortex-m3 -mthumb -D__NEWLIB__ -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
