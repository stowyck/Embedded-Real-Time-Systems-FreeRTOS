...
extern volatile int tpin;


void WavPlayer_Play(const uint8_t *WavArray, const uint32_t Length)
{
	if(tpin && (SongPosition >= 44)) //whenever going from pause to play tpin gets value 1
		{tpin = 0; Init_Timer0(lastDelayValue, 1);
		return;}
